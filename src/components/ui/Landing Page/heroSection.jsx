...
const HeroSection = () => {
  ...
  return (
    <section className="h-fit px-10 py-6 gap-2.5">
      <div className="min-h-202.25 h-fit flex gap-6 pb-16 border-[#322418] border-b-[1.5px]">
        <div className="border-[#5E4630] border-[0.5px]" />

        <div className="max-w-238 h-full flex flex-col justify-start gap-2 pt-2">
          <h1 className="text-5xl font-ivy font-medium w-fit tracking-[-0.079%] leading-[100%]">
            From Representation to Ownership: Why African
          </h1>

          <h1 className="text-5xl font-ivy font-medium w-full tracking-[-0.8%] leading-[100%]">
          ...
          <p className="font-normal font-helvetica text-lg leading-7 tracking-[-1px]">
            <span className="uppercase font-medium">TODAY IN FOCUS:</span> From
            Lagos to Paris, African designers, models, and tastemakers are
        ...
        <div className="flex flex-col gap-6 max-w-84">
          <div className="border-[#322418] border-b-[1.5px] pb-2">
          ...
          {list.map((data) => (
            ...
            >
              <div>
                <h3 className="text-[#252324] text-xl leading-6.5 font-helvetica font-medium">
                  {data.header}
                </h3>
