  ...
  return (
    <section className="flex flex-col items-center gap-10 max-[481px]:px-3 max-[481px]:py-5 p-10">
      ...
      <img
        src={heroSectionPic1}
        alt=""
        className="max-[481px]:w-full min-[1400px]:max-w-259 max-[481px]:h-63.25 h-full object-cover"
      />

      <hr className="border-[#667085] border-t w-full" />

      <div className="w-full max-[732px]:min-h-18.5 min-[732px]:h-18.5 flex max-[732px]:flex-col gap-8 items-center max-[740px]:px-3 px-4">
        <div className="max-w-180.25 w-full flex flex-col gap-2">
          <h2 className="max-[481px]:text-xl max-[859px]:text-3xl text-4xl text-[#000000] font-ivy max-[481px]:leading-[100%] leading-11 font-medium tracking-[-2%]">
        ...
        <form className="w-full max-[481px]:h-12 h-full flex items-center">
          <input
            ...
            className="outline-none border-[#443F41] border-[0.7px] max-h-14 h-full w-full placeholder:text-[#443F41] font-helvetica leading-6 px-3.5 py-4"
          />
