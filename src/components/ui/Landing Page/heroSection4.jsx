...
const HeroSection4 = () => {
  ...
  return (
    <section className="flex flex-col gap-10 max-[768px]:px-3 max-[768px]:pb-5 min-[769px]:max-[1200px]:px-6 px-10">
      ...
      <div className="flex max-[1001px]:flex-col max-[1001px]:gap-10 min-[1001px]:gap-6 min-h-211.5 h-full">
        <div className="max-w-225.5 w-full grid grid-cols-2 grid-rows-2 gap-10 ">
          {list.map((data) => (
            <div
              key={data.id}
              className="max-w-109.5 w-fit min-[768px]:min-h-92.25 h-fit flex flex-col gap-4"
            >
              <img
                src={data.img}
                alt=""
                className="w-full max-[768px]:min-w-40.5 max-[768px]:h-34 min-[768px]:h-66 object-cover min-[768px]:object-top"
              />

              <div className="flex flex-col gap-1">
                <h3 className="font-bold font-helvetica leading-[100%] uppercase max-[768px]:text-[10px] text-[#8D8382] text-xs">
                  {data.topic}
                </h3>

                <h4 className="text-[#000000] max-[1001px]:text-[16px] text-xl max-[768px]:leading-5.5 leading-6.5 tracking-[-1px] font-helvetica font-medium">
                  {data.header}
                </h4>

                <p className="text-[#000000] font-helvetica font-light max-[1001px]:text-xs text-sm leading-5">
                  {data.desc}
                </p>
              </div>
            </div>
